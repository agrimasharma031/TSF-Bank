...
<div class="container">
  <div id="Checkout" class="inline">
    ...
    <div class="form-group">
        <label for="PaymentAmount">Sender's Name</label>
      ...
      <div class="form-group">
        <label or="NameOnCard" >Receiver's Name</label>
  ...
  ?>
      ...
      <div class="form-group">
        ...
        <div class="input-container">
          <input id="Amount" class="form-control" type="text" maxlength="10"></input>

        </div>
      </div>
      <button id="PayButton" class="btn-block btn-success submit-button button" type="submit">
